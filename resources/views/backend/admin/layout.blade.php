                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/manager-order')}}">Order Manager</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/add-coupon')}}">Add Coupon</a></li>
                                <li><a href="{{URL::to('/list-coupon')}}">List Coupons</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/all-user')}}">List USers</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>

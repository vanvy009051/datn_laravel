    ...
    <div class="container" style="background:#222;border-radius:16px;padding: 24px 120px;">
        <div class="col-md-12">
            <div class="row" style="background:#fff; color:#222; padding:15px;">
                ...
                <div class="col-md-6">
                    <p>Chào bạn<strong style="text-decoration: underline;">{{ $shipping_array['shipping_name'] }}</strong></p>
                </div>
                <div class="col-md-12">
                    ...
                    <p>Hình thức thanh toán:
                        <?php if ($shipping_array['shipping_pm_method'] == 0) { ?>
                    <div>Chuyển khoản .Vui lòng thanh toán đơn hàng bằng hình thức chuyển khoản qua STK: 1013879302, NH: VIETCOMBANK, Tên chủ TK: NGUYENVANVY với nội dung "Thanh toán đơn hàng {{ $code['order_code'] }}"</div>
                <?php } elseif ($shipping_array['shipping_pm_method'] == 1) { ?>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4">Tổng tiền thanh toán: {{ number_format($total) }} VNĐ</td>
                        </tr>
                    </tbody>
                </table>
                </div>

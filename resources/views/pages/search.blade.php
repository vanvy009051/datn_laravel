        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title">
                    ...
                    ?>
                    <h3 class="title">Search results for <?php echo '"' . $keyword . '"'; ?></h3>
                </div>
            </div>
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4">
                        <div class="product">
                            <div class="product-img">
                                <img src="{{asset('public/uploads/products/' . $product->thumbnail)}}" style="width:100%;height:360px;object-fit:contain;" alt="">
